...
namespace ZGD.DAL
{
    ...
    public partial class manager_role
    {
        ...
        {
            return DbHelperSQL.GetMaxID("Id", databaseprefix + "manager_role");
        }
        /// <summary>
        /// 增加一条数据
        /// </summary>
        public int Add(Model.manager_role model)
        {
            ...
            if (model.manager_role_values != null)
            {
                foreach (Model.manager_role_value modelt in model.manager_role_values)
                {
                    ...
                    int newId_rv = DbHelperSQL.ExecuteSql(strSql2.ToString(), parameters2);
                }
            }
            return newId;
        }
        ...
        public bool Delete(int id)
        {
            ...
            bool result = DbHelperSQL.ExecuteSqlTran(sqllist);
            if (result)
            {
                return true;
            }
