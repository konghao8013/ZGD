...
namespace ZGD.DAL
{
    ...
    public partial class navigation
    {
        ...
        {
            return DbHelperSQL.GetMaxID("Id", databaseprefix + "navigation");
        }
        /// <summary>
        /// 增加一条数据
        /// </summary>
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        SqlParameter[] parameters = {
					            new SqlParameter("@nav_type", SqlDbType.VarChar,50),
					            new SqlParameter("@name", SqlDbType.VarChar,50),
					            ...
					            new SqlParameter("@class_list", SqlDbType.VarChar,500),
        ...
        public bool Update(string old_name, string new_name, string title)
        {
            ...
            SqlParameter[] parameters = {
					new SqlParameter("@new_name", SqlDbType.VarChar,50),
					new SqlParameter("@title", SqlDbType.VarChar,100),
					new SqlParameter("@old_name", SqlDbType.VarChar,50)};
