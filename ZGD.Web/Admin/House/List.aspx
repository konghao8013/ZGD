<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZGD.Web.Admin.House.List" %>
        ...
        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="left"><a href="/house/<%#Eval("Id")%>" target="_blank"><%#Eval("Title")%></a></td>
                    ...
                    <td align="center">
                        <span><a href="Edit.aspx?id=<%#Eval("Id") %>">编辑</a></span>&nbsp;
                        <span><a href="../GongDi/List.aspx?assID=<%#Eval("Id") %>">楼盘工地</a></span>&nbsp;
                        <span><a href="../GongDi/Add.aspx?assID=<%#Eval("Id") %>">新增工地</a></span>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
