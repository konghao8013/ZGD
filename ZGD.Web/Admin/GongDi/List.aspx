<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZGD.Web.Admin.GongDi.List" %>
        ...
        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="left"><a href="/project/<%#Eval("Id")%>" target="_blank"><%#Eval("Title")%></a></td>
                    <td align="center"><%# Eval("qy")%></td>
        ...
        <div style="line-height: 30px; height: 30px;">
            <div class="right flickr">
                <webdiyer:AspNetPager ID="AspNetPager1" runat="server" CssClass="formfield"
                    ...
                    SubmitButtonClass="formfield" SubmitButtonText="GO" Width="750px"
