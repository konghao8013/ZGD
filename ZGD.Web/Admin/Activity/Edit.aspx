<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="ZGD.Web.Admin.Activity.Edit" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <style type="text/css">
        #imgPanel img { width: 150px; margin-bottom: 5px; }
    </style>
    ...
    <div class="content-tab-wrap">
        <div id="floatHead" class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a href="javascript:;" onclick="tabs(this);" class="selected">修改活动</a></li>
                </ul>
            </div>
        </div>
    </div>
    <form id="form1" runat="server">
        <div class="tab-content">
            ...
            <dl>
                <dt>活动状态</dt>
                <dd>
                    <asp:RadioButtonList ID="cblItem" runat="server"
            ...
            <dl>
                <dt>报名人数</dt>
                <dd>
                    <asp:TextBox ID="txtJoinCount" runat="server" CssClass="input normal" datatype="*">0</asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>浏览次数</dt>
