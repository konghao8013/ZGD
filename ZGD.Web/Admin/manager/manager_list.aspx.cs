...
namespace ZGD.Web.Admin.manager
{
    public partial class manager_list : ZGD.BasePage.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            this.rptList.DataSource = bll.GetList(this.page, this.pageSize, _strWhere, _orderby, out this.totalCount);
            this.rptList.DataBind();

            ////绑定页码
            //txtPageNum.Text = this.pageSize.ToString();
            string pageUrl = Utils.CombUrlTxt("manager_list.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
            pageHtml = Utils.OutPageList(this.pageSize, this.page, this.totalCount, pageUrl, 8);
        }
        #endregion
