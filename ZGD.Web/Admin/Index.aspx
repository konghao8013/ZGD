<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="ZGD.Web.Admin.Index" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="header">
            <div class="header-box">
                <h1 class="logo">后台信息管理系统</h1>
                <ul id="nav" class="nav"></ul>
                <div class="nav-right">
                    <div class="icon-info">
                        <span>您好，<%=admin_info.user_name %><br />
                            <%=new ZGD.BLL.manager_role().GetTitle(admin_info.role_id) %>
                        </span>
                    </div>
                    <div class="icon-option">
                        ...
                        <div class="drop-box">
                            ...
                            <ul class="drop-item">
                                ...
                                <li>
                                    <asp:LinkButton ID="lbtnExit" runat="server" OnClientClick="return confirm('您確定要注销吗？');" OnClick="lbtnExit_Click">注销登录</asp:LinkButton></li>
                            </ul>
                        </div>
                    </div>
                </div>
