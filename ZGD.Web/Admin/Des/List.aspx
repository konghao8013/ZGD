<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZGD.Web.Admin.Des.List" %>
...
<body class="mainbody">
    ...
    <div class="location">
        ...
        <i class="arrow"></i>
        <a href="List.aspx"><span>设计师列表</span></a>
    </div>
    <!--/导航栏-->
        ...
        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><a href="/designer/<%#Eval("Id")%>" target="_blank"><img src="<%#Eval("Photo")%>" width="75" /></a></td>
                    <td align="center"><a href="/designer/<%#Eval("Id")%>" target="_blank"><%#Eval("Name")%>（<%#Eval("Star")%>星）</a></td>
                    <td align="center"><%#Eval("cName")%></td>
                    <td align="center"><%#string.Format("{0:g}", Eval("AddDate"))%></td>
