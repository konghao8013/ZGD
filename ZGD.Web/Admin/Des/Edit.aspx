<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="ZGD.Web.Admin.Des.Edit" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="page-footer">
            <div class="btn-list">
                ...
                <asp:Button ID="btnReset" runat="server" Text="返 回" CssClass="btn yellow" OnClick="btnReset_Click" />
            </div>
            <div class="clear"></div>
        </div>
        <!--/工具栏-->
