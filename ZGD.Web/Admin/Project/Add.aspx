    ...
    <script type="text/javascript">
        ...
        function bindImg() {
            ...
            for (var i = 0; i < hidimg.length - 1; i++) {
                temphtml += '<div class="uploadImg"><div><img src="' + hidimg[i] + '" /></div><input type="text" class="input" style="width:100px;" value="' + hidtitle[i] + '" /><a href="javascript:void(0)" onclick="deleteImg(' + i + ',' + _img_type + ')">X</a></div>';
                hidtemp1 += hidimg[i] + ",";
                hidtemp2 += hidtitle[i] + ",";
            }
    ...
    <form id="form1" runat="server">
        <div class="tab-content">
            ...
            <dl>
                <dt>案例图集</dt>
                <dd>
                    <a href="javascript:;" onclick="showUpImg(1);" style="font-weight: 600; color: Red; text-decoration: underline">点击上传案例图</a><span>（尺寸850*543px）</span><br />
                    <div id="divHImg"></div>
