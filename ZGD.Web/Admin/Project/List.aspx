<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZGD.Web.Admin.Project.List" %>
                ...
                <div class="l-list">
                    ...
                    <div class="menu-list">
                        <div class="rule-single-select">
                            <asp:DropDownList ID="ddlFG" runat="server" CssClass="select"
                                AutoPostBack="True" OnSelectedIndexChanged="ddlFG_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="rule-single-select">
                            <asp:DropDownList ID="ddlHX" runat="server" CssClass="select"
                                AutoPostBack="True" OnSelectedIndexChanged="ddlHX_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="rule-single-select">
                            <asp:DropDownList ID="ddlGN" runat="server" CssClass="select"
                                AutoPostBack="True" OnSelectedIndexChanged="ddlGN_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="rule-single-select">
                            <asp:DropDownList ID="ddlMJ" runat="server" CssClass="select"
                                AutoPostBack="True" OnSelectedIndexChanged="ddlMJ_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="rule-single-select">
