<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardEdit.aspx.cs" Inherits="ZGD.Web.Admin.WeiXin.CardEdit" %>
...
<body style="padding: 10px;">
    <form id="form1" runat="server">
        <div class="navigation">
            <span class="back"><a href="CardList.aspx">返回列表</a></span><b>您当前的位置：微信管理 &gt;微名片管理 &gt; 编辑微名片</b>
        </div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="uploading">正在上传，请稍候...</span><span>（尺寸100×100px）</span>
                </td>
            </tr>
            <tr>
        ...
        <div style="margin-top: 10px; text-align: center;">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
   <asp:Button ID="btnReset" runat="server" Text="返回" CssClass="submit"
