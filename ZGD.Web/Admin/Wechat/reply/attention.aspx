<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attention.aspx.cs" Inherits="ZGD.Web.Admin.wechat.reply.attention" %>
...
<body class="mainbody">
    <form name="form1" id="form1">
        ...
        <div class="location">
            ...
            <a href="../../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>关注时回复</span>
        </div>
        <!--/导航栏-->
        <%if (fodder_id == "0")
          {%>
...
<script>
    function reSelect() {
        ...
        m.fun = function (id) {
            if (id != m.id && id != 0) {
                $.post("attention.aspx", { id: id }, function (e) {
