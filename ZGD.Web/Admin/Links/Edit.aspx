<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="ZGD.Web.Admin.Links.Edit" %>
...
<body class="mainbody">
    ...
    <form id="form1" runat="server">
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑链接</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            ...
            <dl class="upordown" style="display: none" id="tr_img_panel" runat="server">
                <dt>图片上传</dt>
                <dd>
