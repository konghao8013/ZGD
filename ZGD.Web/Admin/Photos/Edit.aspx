<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="ZGD.Web.Admin.Photos.Edit" %>
    ...
    <div class="content-tab-wrap">
        <div id="floatHead" class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑<%=title %></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <asp:TextBox ID="txtImgUrl" runat="server" datatype="*1-250" CssClass="input normal upload-path" nullmsg="请上传封面" />
            ...
            <%--<dl>
                <dt>相册图集</dt>
                <dd>
                    <a href="javascript:;" onclick="showUpImg(1);" style="font-weight: 600; color: Red; text-decoration: underline">点击上传图集</a><span>（尺寸710*450px）</span><br />
                    <div id="divHImg"></div>
            ...
            <dl>
                <dt>相册序号</dt>
                <dd>
                    <asp:TextBox ID="txtSort" Text="0" runat="server" CssClass="input normal" datatype="/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/" errormsg="请输入正确的相册序号" sucmsg=" "></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>置顶属性</dt>
