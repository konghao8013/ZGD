<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZGD.Web.Admin.Photos.List" %>
...
<body class="mainbody">
    ...
    <div class="location">
        ...
        <i class="arrow"></i>
        <a href="List.aspx"><span>相册列表</span></a>
    </div>
    <!--/导航栏-->
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="Add.aspx?t=<%=pType %>"><i></i><span>新增</span></a></li>
        ...
        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><a href="/case?id=<%#Eval("Id") %>" target="_blank">
                        <img src="<%#Eval("ImgUrl")%>" width="120" height="90" /></a></td>
