...
namespace ZGD.BLL
{
    ...
    {
        private readonly ZGD.DAL.Activity dal = new ZGD.DAL.Activity();
        public Activity()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public ZGD.Model.Activity GetModelByCache(int ID)
        {

            string CacheKey = "ActivityModel-" + ID;
            ...
            return (ZGD.Model.Activity)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZGD.Model.Activity> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZGD.Model.Activity> DataTableToList(DataTable dt)
        {
            List<ZGD.Model.Activity> modelList = new List<ZGD.Model.Activity>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                ZGD.Model.Activity model;
