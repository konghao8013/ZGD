...
namespace ZGD.BLL
{
	...
	{
		private readonly ZGD.DAL.Feedback dal=new ZGD.DAL.Feedback();
		public Feedback()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZGD.Model.Feedback GetModelByCache(int Id)
		{
			...
			return (ZGD.Model.Feedback)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZGD.Model.Feedback> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZGD.Model.Feedback> DataTableToList(DataTable dt)
		{
			List<ZGD.Model.Feedback> modelList = new List<ZGD.Model.Feedback>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZGD.Model.Feedback model;
