...
namespace ZGD.BLL
{
	...
	{
		private readonly ZGD.DAL.Member dal=new ZGD.DAL.Member();
		public Member()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZGD.Model.Member GetModelByCache(int Id)
		{
			...
			return (ZGD.Model.Member)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZGD.Model.Member> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZGD.Model.Member> DataTableToList(DataTable dt)
		{
			List<ZGD.Model.Member> modelList = new List<ZGD.Model.Member>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZGD.Model.Member model;
