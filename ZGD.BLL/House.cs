...
namespace ZGD.BLL
{
    ...
    {
        private readonly ZGD.DAL.House dal = new ZGD.DAL.House();
        public House()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public ZGD.Model.House GetModelByCache(int ID)
        {

            string CacheKey = "HouseModel-" + ID;
            ...
            return (ZGD.Model.House)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZGD.Model.House> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZGD.Model.House> DataTableToList(DataTable dt)
        {
            List<ZGD.Model.House> modelList = new List<ZGD.Model.House>();
        ...
        /// 绑定类别DropDownList控制
        /// </summary>
        public void BindHouse(System.Web.UI.WebControls.DropDownList ddl)
        {
            DataSet ds = GetList(" IsLock=0 ");
            ddl.DataSource = ds;
            ddl.DataTextField = "Title";
            ddl.DataValueField = "ID";
            ddl.DataBind();
            ddl.Items.Insert(0, new System.Web.UI.WebControls.ListItem("请选择楼盘", "0"));
        }
