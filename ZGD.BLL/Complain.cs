...
namespace ZGD.BLL
{
	...
	{
		private readonly ZGD.DAL.Complain dal=new ZGD.DAL.Complain();
		public Complain()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZGD.Model.Complain GetModelByCache(int ID)
		{
			...
			return (ZGD.Model.Complain)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZGD.Model.Complain> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZGD.Model.Complain> DataTableToList(DataTable dt)
		{
			List<ZGD.Model.Complain> modelList = new List<ZGD.Model.Complain>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZGD.Model.Complain model;
