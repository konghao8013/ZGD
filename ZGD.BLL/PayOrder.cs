...
namespace ZGD.BLL
{
	...
	{
		private readonly ZGD.DAL.PayOrder dal=new ZGD.DAL.PayOrder();
		public PayOrder()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZGD.Model.PayOrder GetModelByCache(int ID)
		{
			...
			return (ZGD.Model.PayOrder)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZGD.Model.PayOrder> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZGD.Model.PayOrder> DataTableToList(DataTable dt)
		{
			List<ZGD.Model.PayOrder> modelList = new List<ZGD.Model.PayOrder>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZGD.Model.PayOrder model;
