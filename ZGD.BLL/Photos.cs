...
namespace ZGD.BLL
{
    ...
    {
        private readonly ZGD.DAL.Photos dal = new ZGD.DAL.Photos();
        public Photos()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public ZGD.Model.Photos GetModelByCache(int ID)
        {
            ...
            return (ZGD.Model.Photos)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZGD.Model.Photos> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<ZGD.Model.Photos> DataTableToList(DataTable dt)
        {
            List<ZGD.Model.Photos> modelList = new List<ZGD.Model.Photos>();
