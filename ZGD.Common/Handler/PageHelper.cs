...
namespace ZGD.Common
{
    public static class RequestUtility
    {
        ...
        /// <returns></returns>
        public static string HttpGet(string url, int timeOut, CookieContainer cookieContainer = null, Encoding encoding = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static string HttpPost(string url, int timeOut = 30, CookieContainer cookieContainer = null, Dictionary<string, string> formData = null, Encoding encoding = null)
        {
            ...
            return HttpPost(url, timeOut, cookieContainer, ms, null, null, encoding);
        }
        ...
        /// <returns></returns>
        public static string HttpPost(string url, int timeOut, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.Timeout = timeOut;
