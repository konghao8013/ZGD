...
namespace ZGD.Common
{
    public class DTKeys
    {
        ...
        /// PC站域名
        /// </summary>
        public static string Web = System.Configuration.ConfigurationManager.AppSettings["Web"].ToString();
        /// <summary>
        /// 手机站域名
        /// </summary>
        public static string Mobile = System.Configuration.ConfigurationManager.AppSettings["Mobile"].ToString();
        /// <summary>
        /// SSOKey
        /// </summary>
        public static string SSOKey = System.Configuration.ConfigurationManager.AppSettings["SSOKey"].ToString(); 
    }
}
